...
describe("Source code is valid", () => {
  test("JavaScript lints without errors", async () => {
    const sources = ["index.js", "Model.js", "View.js", "Controller.js"].map(
      (src) => __dirname + "/js/" + src
    );
    const linterOptions = {
      overrideConfig: {
...
describe("Model.js module", () => {
  ...
  test("initial processing and getIncompleteTasks() function", () => {
    ...
    expect(incompleteTasks[lastIdx].description).toEqual(
...
describe("Controller.js module", () => {
  ...
  test("markCompleteCallback() function", () => {
    ...
    expect(liElems.last().text()).toMatch(
      incompleteTasks[incompleteTasks.length - 1].description
    );
