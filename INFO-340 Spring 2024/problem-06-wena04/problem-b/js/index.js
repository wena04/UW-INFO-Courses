...
document.querySelector("#dobInput").addEventListener("input", function () {
  let dob = document.querySelector("#dobInput").value;
  let age = getYearsSince(dob);
  if (age < 13 || age > 200) {
    document
      .querySelector("#dobInput")
      .setCustomValidity("You need to be at least 13 years old.");
...
function validatePasswordMatch() {
  ...
  let confirmPassword = document.querySelector("#passwordConfirmInput").value;
